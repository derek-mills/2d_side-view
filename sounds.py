...
sound_bullet_wall_hit_1.set_volume(SOUND_VOLUME*0.3)
...
sound_sword_hits_shield_1 = pygame.mixer.Sound('SFX/sword_strikes_shield.mp3')
sound_sword_hits_shield_1.set_volume(SOUND_VOLUME*.2)
