...
kitchen_knife = {
    ...
    'graphics': (
        {'sprite frame': (40,60,40,60),
         'sprite name': 'kitchen knife',
         'sprite scale': 3},
        {'sprite frame': (80,60,40,60),
...
fireball_staff = {
    ...
    'amount decrease speed': 0,
    'graphics': (
        {'sprite frame': (40, 0, 40, 60),
         'sprite name': 'fireball staff',
         'sprite scale': 3},
        {'sprite frame': (80, 0, 40, 60),
...
spikeball_staff = {
    ...
    'amount decrease speed': 0,
    'graphics': (
        {'sprite frame': (40, 360, 40, 60),
         'sprite name': 'spikeball staff',
         'sprite scale': 3},
        {'sprite frame': (80, 360, 80, 30),
...
jake_kick = {
    ...
    'amount decrease speed': 0,
    'graphics': (
        {'sprite frame': (40, 300, 80, 120),
         'sprite name': 'boot',
         'sprite scale': 2},
        {'sprite frame': (80, 300, 80, 120),
...
jake_punch = {
    ...
    'amount decrease speed': 0,
    'graphics': (
        {'sprite frame': (40, 300, 40, 60),
         'sprite name': 'boot',
         'sprite scale': 2},
        # {'sprite frame': (80, 300, 40, 60),
        #  'sprite name': 'jake kick demolisher',
        #  'sprite scale': 5},
    ),
...
axe = {
    ...
    'amount decrease speed': 0,
    'graphics': (
        {'sprite frame': (40, 420, 40, 60),
         'sprite name': 'axe',
         'sprite scale': 3},
        {'sprite frame': (80, 420, 40, 60),
         'sprite name': 'axe 45 demolisher',
         'sprite scale': 9},
        {'sprite frame': (120, 420, 40, 60),
         'sprite name': 'axe 0 demolisher',
         'sprite scale': 9},
        {'sprite frame': (80, 210, 40, 60),
...
demon_2_close = {
    ...
    'amount decrease speed': 0,
    'graphics': (
        {'sprite frame': (80, 240,83,59),
         'sprite name': 'demon 2 claw demolisher',
         'sprite scale': 5},
        {'sprite frame': (400, 240, 120, 60),
         'sprite name': 'demon 2 claw demolisher 2',
         'sprite scale': 5},
    ),
...
pistol = {
    ...
    'amount decrease speed': 0,
    'graphics': (
        {'sprite frame': (33,490,53,45),
         'sprite name': 'pistol',
         'sprite scale': 2},
        {'sprite frame': (84,484,71,48),
...
small_shield = {
    ...
    'amount decrease speed': 0,
    'graphics': (
        {'sprite frame': (35,540,49,70),
         'sprite name': 'small shield',
         'sprite scale': 2},
        {'sprite frame': (94,535,20,76),
